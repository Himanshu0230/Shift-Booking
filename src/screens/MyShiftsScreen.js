...
const MyShiftsScreen = ({ shiftData, fetchShift }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <SectionList
                ...
                renderItem={({ item }) => (<MyShiftItem title={item} />)}
...
export default connect(mapStateToProps, mapDispatchToProps)(MyShiftsScreen)
